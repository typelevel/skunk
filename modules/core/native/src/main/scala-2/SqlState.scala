...
sealed abstract class SqlState(val code: String) {
...
object SqlState {
  ...
  val values: IndexedSeq[SqlState] = Vector(
    ...
    LockFileExists,
    LockNotAvailable,
    ModifyingSqlDataNotPermitted2F,
    ...
    ProhibitedSqlStatementAttempted2F,
    ProhibitedSqlStatementAttempted38,
    ProtocolViolation,
    QueryCanceled,
    RaiseException,
    ReadOnlySqlTransaction,
    ReadingSqlDataNotPermitted2F,
